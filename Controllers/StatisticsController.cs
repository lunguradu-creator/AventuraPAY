...
namespace AventuraPAY.Controllers
{
    public class StatisticsController
    {
        ...
        private readonly Statistics view;
        private Views.statistica statistica;

        public StatisticsController(Statistics view)
        {
            this.model = new StatisticsModel();
            this.view = view;
        }

        public StatisticsController(Views.statistica statistica)
        {
